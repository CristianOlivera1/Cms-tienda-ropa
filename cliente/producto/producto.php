        ...
        <div class="row">
            <div class="col-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link d-flex justify-content-between align-items-center" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                    ...
                    while ($category = mysqli_fetch_assoc($categories)) {
                        ...
                        echo "<a class='nav-link $activeClass d-flex justify-content-between align-items-center' id='v-pills-{$category['catId']}-tab' data-toggle='pill' href='#v-pills-{$category['catId']}' role='tab' aria-controls='v-pills-{$category['catId']}' aria-selected='$ariaSelected'>{$category['catNombre']} <span class='text-black-50 ml-2'>($product_count)</span></a>";
                    }
                    ?>
                </div>
            </div>
