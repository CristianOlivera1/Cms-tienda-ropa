...
FROM ventas v INNER JOIN  detalleventa d ON v.venId = d.venId INNER JOIN 
    stock s ON s.stoId = d.stoId INNER JOIN talla t ON s.talId = t.talId 
INNER JOIN color c ON c.colId = s.colId INNER JOIN producto p ON p.proId = s.proId
WHERE v.venId = $venId GROUP BY p.proNombre, c.colNombre, t.talNombre, d.detVenPrecio;
";
                            ...
                            <?php if ($productos): 
                                ...
                                foreach ($productos as $producto): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger eliminar-btn" data-id="<?php echo htmlspecialchars($producto['detVenId']); ?>">
